...
>
    <section class="bg-white">
        <div class="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-24">
            ...
            <div class="mx-auto mt-12 max-w-4xl rounded-2xl border border-slate-200 bg-slate-50/70 p-8">
                <p class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Response times</p>
                <div class="mt-4 grid gap-4 sm:grid-cols-3">
                    <div class="rounded-xl border border-slate-200 bg-white p-4 text-center">
                        <p class="text-sm font-semibold text-slate-900">&lt; 1 business day</p>
                        <p class="mt-1 text-xs text-slate-600">General replies</p>
                    </div>
                    <div class="rounded-xl border border-slate-200 bg-white p-4 text-center">
                        <p class="text-sm font-semibold text-slate-900">Priority queue</p>
                        <p class="mt-1 text-xs text-slate-600">Pro and Agency support</p>
                    </div>
                    <div class="rounded-xl border border-slate-200 bg-white p-4 text-center">
                        <p class="text-sm font-semibold text-slate-900">Weekly demo slots</p>
                        <p class="mt-1 text-xs text-slate-600">Product walkthroughs</p>
                    </div>
                </div>
            </div>
        </div>
