    ...
    <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-5">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-end">
            ...
            <div class="flex flex-1 items-end gap-2">
                <div class="flex-1">
                    <label class="mb-1 block text-[11px] font-medium text-slate-700 dark:text-slate-300">Start Date</label>
                ...
                <span class="pb-1.5 text-xs text-slate-400">to</span>
                <div class="flex-1">
                    <label class="mb-1 block text-[11px] font-medium text-slate-700 dark:text-slate-300">End Date</label>
