        ...
        <form method="POST" action="{{ route('admin.plugin-releases.store') }}" enctype="multipart/form-data" class="rounded border border-slate-200 bg-white p-4">
            ...
            <div class="grid gap-2 md:grid-cols-3">
                ...
                <div class="md:col-span-3">
                    <label class="block text-xs font-semibold text-slate-700">Plugin ZIP <span class="font-normal text-slate-500">(optional — leave empty to package from <code class="rounded bg-slate-100 px-1 font-mono text-[11px]">ebq-seo-wp/</code> source)</span></label>
                    ...
                    <p class="mt-1 text-[11px] text-slate-500">Max 20 MB. When provided with <em>publish now</em>, the uploaded file replaces <code class="rounded bg-slate-100 px-1 font-mono">public/downloads/ebq-seo.zip</code> directly.</p>
                </div>
            </div>
