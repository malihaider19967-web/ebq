                        ...
                        <div>
                            ...
                            <dl class="mt-8 space-y-5">
                                @foreach ([
                                    ...
                                    ['Audit vs. performance', 'Audited pages with Lighthouse scores under 70 that still attract real impressions — technical debt measurably costing traffic.'],
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="grid gap-12 lg:grid-cols-2 lg:items-center">
                        ...
                        <div>
                            ...
                            <h2 class="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">Lighthouse + content + keywords in one pass</h2>
                            <p class="mt-5 text-base leading-7 text-slate-700 sm:text-lg">
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div class="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                        @foreach ([
                            ...
                            ['Lighthouse', 'Full Core Web Vitals + performance score on mobile and desktop, piped straight into page audits.'],
