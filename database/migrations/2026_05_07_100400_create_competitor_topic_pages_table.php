...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('competitor_topic_pages', function (Blueprint $table): void {
            $table->foreignUlid('competitor_topic_id')->constrained('competitor_topics')->cascadeOnDelete();
            $table->foreignUlid('competitor_page_id')->constrained('competitor_pages')->cascadeOnDelete();
            $table->timestamps();
