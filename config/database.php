...
return [
    ...
    */
    ...
    'redis' => [
        ...
        // Dedicated connection for Horizon's own metadata (supervisors, job
        // metrics, failed-job index) on its own Redis DB, so it never collides
        // with the queue ('default') or cache ('cache'). Referenced by
        // config/horizon.php `'use' => 'horizon'`.
        'horizon' => [
            'url' => env('REDIS_URL'),
            'host' => env('REDIS_HOST', '127.0.0.1'),
            'username' => env('REDIS_USERNAME'),
